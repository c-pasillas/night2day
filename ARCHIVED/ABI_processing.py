...
def main(args):
    ...
    datas = [process_set(matched[datetime], idx, len(matched)) for idx, datetime in enumerate(sorted(matched)[45:])]
    ...
    filename = path / f'{path.name}_RefGOES_2022trial_case.npz'
