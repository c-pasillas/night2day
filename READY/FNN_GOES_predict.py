...
def function_GOES(model, case, PREDICTORS):
    ...
    #using all
    Cbands = ["C07norm", "C11norm", "C13norm","C14norm", "C15norm", "normBTD_C07C11","normBTD_C07C13", "normBTD_C07C14", "normBTD_C07C15", "normBTD_C11C13","normBTD_C11C14", "normBTD_C11C15",'normBTD_C13C14',"normBTD_C13C15", "normBTD_C14C15"] 
