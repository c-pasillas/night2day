...
def predict(args):
    ...
    #savepath = f"ML_truth_DATA_{args.npz_path[:-4]}_MODEL_{args.model_path}_{made}.npz" 
    savepath = f"ML_truth_DATA_SINGLESAMPLE_MODEL_{args.model_path}_{made}.npz"#[0:9]  
