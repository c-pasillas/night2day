...
#     #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
#     filename = GOESpath / f'{GOESpath.name}_RefGOES_SVCC_0-20.npz'
#     log.info(f'Writing {blue}{filename.name}{reset}\n' +
#              f'{orange}Channels{reset} {channels}\n{orange}')
...
#     gc.collect()
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    filename = GOESpath / f'{GOESpath.name}_RefGOES_SVCC_20-40.npz'
    log.info(f'Writing {blue}{filename.name}{reset}\n' +
            f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    filename = GOESpath / f'{GOESpath.name}_RefGOES_SVCC_40-60.npz'
    log.info(f'Writing {blue}{filename.name}{reset}\n' +
            f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    filename = GOESpath / f'{GOESpath.name}_RefGOES_SVCC_60-80.npz'
    log.info(f'Writing {blue}{filename.name}{reset}\n' +
            f'{orange}Channels{reset} {channels}\n{orange}')
    ...
    datas5 = []
    dcount5 = 0
    for datetime in sorted(matched)[80:102]:
        log.info(f"the DTG is, {datetime}, and matched[datetime] is {matched[datetime]}")
        try:
    ...
    #filename2 = /gdata5/cpasilla/DATA/f'{path.name}_RefGOES_case.npz'
    filename = GOESpath / f'{GOESpath.name}_RefGOES_SVCC_80-102.npz'
    log.info(f'Writing {blue}{filename.name}{reset}\n' +
            f'{orange}Channels{reset} {channels}\n{orange}')
